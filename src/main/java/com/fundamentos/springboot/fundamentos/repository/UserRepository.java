...
public interface UserRepository extends JpaRepository<User,Long> {
    ...
    List<User> findByEmailContainingOrderById(String email);

    @Query("SELECT new com.fundamentos.springboot.fundamentos.dto.UserDto(u.id, u.name, u.birthday)" +" FROM User u "+ "WHERE u.birthday=:parametroFecha " +
